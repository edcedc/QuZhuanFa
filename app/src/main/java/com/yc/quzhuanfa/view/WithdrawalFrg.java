...
import com.yc.quzhuanfa.adapter.WithdrawalAdapter;
 ...
 *  收入明细
 */
public class WithdrawalFrg extends BaseFragment<BaseListPresenter, BRecyclerBinding> implements BaseListContract.View {
    ...
    protected void initView(View view) {
        ...
        if (adapter == null) {
            adapter = new WithdrawalAdapter(act, listBean);
        }
        ...
        setRefreshLayout(mB.refreshLayout, new RefreshListenerAdapter() {
            ...
            public void onRefresh(TwinklingRefreshLayout refreshLayout) {
                mPresenter.onRequest(pagerNumber = 1, CloudApi.userGetUserCashList);
            }
