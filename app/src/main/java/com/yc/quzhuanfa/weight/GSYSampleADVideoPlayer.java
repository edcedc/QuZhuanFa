...
public class GSYSampleADVideoPlayer extends ListGSYVideoPlayer {
    ...
    protected void init(Context context) {
        ...
        mJumpAd = findViewById(com.shuyu.gsyvideoplayer.R.id.jump_ad);
        mADTime = (TextView) findViewById(com.shuyu.gsyvideoplayer.R.id.ad_time);
        mWidgetContainer = (ViewGroup) findViewById(com.shuyu.gsyvideoplayer.R.id.widget_container);
        findViewById(R.id.back).setOnClickListener(view -> ActivityUtils.finishActivity(VideoAct.class));
        if (mJumpAd != null) {
        ...
        SeekBar seekBar = findViewById(com.shuyu.gsyvideoplayer.R.id.progress);
